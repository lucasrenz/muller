-- Complete setup for DenÃºncias module
...
-- =========================================================
-- 2) Protocolo and CÃ³digo geradores
-- =========================================================
...
-- =========================================================
-- 8) FUNÃ‡Ã•ES DE TRIGGER (seguras)
...
as $$
begin
  -- Define resposta pÃºblica inicial e data
  new.resposta_publica_atual := coalesce(new.resposta_publica_atual, 'Sua denÃºncia foi recebida com sucesso e serÃ¡ analisada pela equipe responsÃ¡vel.');
...
begin
  ...
  insert into public.denuncia_logs (
    ...
    case when new.anonimo then 'DenÃºncia anÃ´nima' else coalesce(new.nome_denunciante,'Denunciante identificado') end
  );

  -- Insere publicaÃ§Ã£o ao denunciante
...
-- =========================================================
-- 9) FUNÃ‡Ã•ES AUXILIARES (PUBLICAR RESPOSTA / ADICIONAR NOTA)
-- =========================================================
...
--  - leitura/ediÃ§Ã£o de denuncias Ã© sÃ³ para authenticated
--  - logs/publicacoes/notas internos: apenas leitura/execuÃ§Ã£o por autenticados
-- =========================================================
