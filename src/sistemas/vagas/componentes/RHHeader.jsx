...
import { Search, RefreshCw, Plus, Sparkles, LogOut, UserPlus } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            {isAdmin && (
              <motion.button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition-all"
                title="Criar usuário"
              >
