...
import RequestDataModal from '@/sistemas/financeiro/componentes/RequestDataModal';
import ResponseDecisionModal from '@/sistemas/financeiro/componentes/ResponseDecisionModal';
import EditStatusModal from '@/sistemas/financeiro/componentes/EditStatusModal';
import ContractLoadingOverlay from '@/sistemas/financeiro/componentes/ContractLoadingOverlay';
import WhatsAppMessageModal from '@/sistemas/financeiro/componentes/WhatsAppMessageModal';
import { generateAndOpenContract } from '@/sistemas/financeiro/servicos/contratoUtils';
...
const OperatorDashboard = () => {
  ...
  const isAdmin = (perfil?.tipo || '').toLowerCase().trim() === 'admin';
            ...
            <div className="flex items-center gap-2">
              ...
              {isAdmin && (
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition-colors"
                >
